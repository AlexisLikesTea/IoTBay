...
public class editCustomer extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            String custEmail = (String) request.getParameter("customerEmail"); 
            String custPass = (String) request.getParameter("customerPass"); 
            Customer edCustomer = (Customer) manager.findCustomer(custEmail, custPass);
            session.setAttribute("editCustomer", edCustomer);
